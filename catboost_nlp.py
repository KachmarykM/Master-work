...
model_w2v = Word2Vec(sentences=df['processed_description'].tolist(), vector_size=100, window=5, min_count=1, workers=4)
...
# model.save_model('C:/Users/maxim/PycharmProjects/Master_Diploma/models/catboost_nlp_v2.cbm', format='cbm')
